...
const Footer = () => {
    return (
        <>
            <footer className="bg-secondary text-light p-4 mt-4">
                <div className="container">
                    <div className="row">
                        <nav className="col-md-4">
                            <h6 className="text-uppercase mb-3">Services</h6>
                            <ul className="list-unstyled">
                                <li><a href="#" className="text-light text-decoration-none">Branding</a></li>
                                <li><a href="#" className="text-light text-decoration-none">Design</a></li>
                                <li><a href="#" className="text-light text-decoration-none">Marketing</a></li>
                                <li><a href="#" className="text-light text-decoration-none">Advertisement</a></li>
                            </ul>
                        </nav>
                        <nav className="col-md-4">
            ...
            <footer className="bg-secondary text-light d-flex justify-content-between align-items-center p-4">
                <div className="container">
                    <div className="row">
                        <div className="col-md-6">
                            <p className="mb-0">
                                Tamay Industries Ltd.<br />
